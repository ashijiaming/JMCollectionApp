...
Java_com_jm_media_record_FFmpegJni_prepareJXFFmpegEncoder(JNIEnv *env,
                                                          jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_jm_media_record_FFmpegJni_encodeFrame2H264(JNIEnv *env,
                                                    jclass type,
                                                    jbyteArray data_) {
...
Java_com_jm_media_record_FFmpegJni_getFFmpegConfig(JNIEnv *env,
                                                   jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_jm_media_record_FFmpegJni_encodeFrame2AAC(JNIEnv *env,
                                                   jclass type,
                                                   jbyteArray data_) {
    jbyte *elements = env->GetByteArrayElements(data_, 0);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_jm_media_record_FFmpegJni_recordEnd(JNIEnv *env,
                                             jclass type) {
...
Java_com_jm_media_record_FFmpegJni_nativeRelease(JNIEnv *env,
                                                 jclass type) {
