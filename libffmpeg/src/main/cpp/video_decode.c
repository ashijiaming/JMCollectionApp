...
Java_com_jm_ffmpeg_jni_DecodeVideo_decode(JNIEnv *env, jobject instance, jstring input_,
                                                     jstring output_) {
...
Java_com_jm_ffmpeg_jni_DecodeVideo_render(JNIEnv *env, jobject instance, jstring input_, jobject surface) {
...
JNIEXPORT void JNICALL
Java_com_jm_ffmpeg_jni_DecodeVideo_sound(JNIEnv *env, jobject instance, jstring input_, jstring output_) {
    const char *input = (*env)->GetStringUTFChars(env, input_, 0);
