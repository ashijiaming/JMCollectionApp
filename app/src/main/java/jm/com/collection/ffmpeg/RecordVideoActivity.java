...
import com.jm.media.model.AutoVBRMode;
import com.jm.media.model.BaseMediaBitrateConfig;
import com.jm.media.model.CBRMode;
import com.jm.media.model.LocalMediaConfig;
import com.jm.media.model.MediaRecorderConfig;
import com.jm.media.model.OnlyCompressOverBean;
import com.jm.media.model.VBRMode;
import com.jm.media.record.DeviceUtils;
import com.jm.media.record.JianXiCamera;
import com.jm.media.record.LocalMediaCompress;
import com.jm.media.record.MediaRecorderActivity;
...
public class RecordVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tempFile = ConfigUtil.createTempFile();
        JianXiCamera.setVideoCachePath(tempFile+File.separator);
        initView();
        initEvent();
        permissionCheck();
    }
    ...
    public void go(View c) {
        ...
        MediaRecorderConfig config = new MediaRecorderConfig.Buidler()
                ...
                .build();
        MediaRecorderActivity.goSmallVideoRecorder(this, NdkProjectActivity.class.getName(), config);
                    ...
                    if (!TextUtils.isEmpty(mime_type) && mime_type.contains("video") && !TextUtils.isEmpty(_data)) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent intent = new Intent(RecordVideoActivity.this, NdkProjectActivity.class);
